...
const navItems = [
  ...
  { key: "projects", label: "Projekte", icon: Folder },
  { key: "documents", label: "Dokumente", icon: FileText },
  { key: "appointments", label: "Termine", icon: CalendarDays },
  { key: "messages", label: "Nachrichten", icon: MessageCircle },
]
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="flex h-full flex-col">
          ...
          {/* Navigation + Notifications (scrollable middle) */}
          <div className="flex-1 overflow-y-auto px-4 py-6 space-y-6">
            ...
            >
              ...
              >
                ...
                {sidebarOpen && <span>Neues Projekt starten</span>}
              </div>
            </button>
